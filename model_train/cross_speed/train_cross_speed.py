...
def main() -> None:
    ...
    parser.add_argument("--dataset", type=str, default="A5")
    parser.add_argument("--train_subsets", type=str, default="A5_2")
    parser.add_argument("--test_subset", type=str, default="A5_1")
    ...
    results_dir = Path(__file__).resolve().parents[1] / "results" / "speed"
    ...
    print(f"Test Acc (Cross-Speed): {test_acc:.4f}", flush=True)
