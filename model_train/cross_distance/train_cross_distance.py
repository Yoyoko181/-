...
def main() -> None:
    ...
    parser.add_argument("--dataset", type=str, default="A2")
    parser.add_argument("--train_subsets", type=str, default="A2_1")
    parser.add_argument("--test_subset", type=str, default="A2_3")
    ...
    results_dir = Path(__file__).resolve().parents[1] / "results" / "distance"
    ...
    print(f"Test Acc (Cross-Distance): {test_acc:.4f}", flush=True)
